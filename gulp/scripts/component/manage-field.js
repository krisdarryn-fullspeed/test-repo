var ManageField = {
    ...
    init: function() {
        ...
        this.$componentId = $('#cms_component_id');
        this.initSort();
    ...
    initSort: function() {
        ...
        ManageField.sortTable = dragula([$('#table-component tbody').get(0)], {
            revertOnSpill: true,
    ...
    saveFields: function(e) {
        ...
        formData.append('cms_component_id', ManageField.$componentId.val());
        formData.append('has_sorted', ManageField.hasSorted);
        ...
        $('.f-row').each(function(i, element) {
            ...
            if (is.not.undefined($row.data('is-exist')) && (($row.data('is-exist') == 'true') || $row.data('is-exist'))) {
                formData.append('existing_fields[' + i +'][cms_component_field_id]', field.cms_component_field_id);
        ...
        $.ajax({
            url: pageVars.url.componentManageField + '/' + ManageField.$componentId.val(),
            type: 'POST',
            cache: false,
            contentType: false,
            processData: false,
            ...
            success: function(response, textStatus, jqXHR) {
                ...
                switch (response.status) {
                    case ajaxStatus.success:
                        ...
                        location.href = pageVars.url.componentEdit + '/' + ManageField.$componentId.val();
                        break;
    ...
    edit: function(dialogRef, $btn) {
        ...
        if (is.not.undefined(field.cms_component_field_id)) {
            ...
            buttons: [
                ...
                },
                {
                    ...
                    action: function(dialogRef) {
                        ...
                        if (is.not.undefined($row.data('is-exist')) && (($row.data('is-exist') == 'true') || $row.data('is-exist'))) {
                            ManageField.removeFields.push(field.cms_component_field_id);
                        }
